...
public class Main
{
	public static void main(String[] args) {
		...
		System.out.println("Enter the intial temp, in Celsius");
		double initialTemp = reader.nextDouble();
		if(initialTemp < -273.14)
		    initialTemp = -273.14;
		System.out.println("Enter the final temp, in Celsius");
	...
	public static double tempChangeSolid(double mass, double startTemp, double endTemp, String endPhase, boolean endothermic){
	   if(!endPhase.equals("solid"))
	       endTemp = 0;
	   double energyChange = round(mass*0.002108*(endTemp - startTemp));   //0.002108 is in KJ, mass times Specific heat capcity times temperature change
	   if(endothermic)
    ...
    public static double tempChangeLiquid(double mass, double startTemp, double endTemp, String endPhase, boolean endothermic){
	   ...
	   if(endPhase.equals("vapor"))
	       endTemp = 100;
	   double energyChange = round(mass*0.004108*(endTemp - startTemp)); 
	   if(endothermic)
